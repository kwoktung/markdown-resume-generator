/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 5796d1d233e3fb1923d72f8df6a8d987)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    NEXTAUTH_URL: string;
    DB: D1Database;
    PDF_EXPORT_RATE_LIMITER: RateLimit;
    BROWSER: Fetcher;
    AI: Ai;
    ASSETS: Fetcher;
  }
